| Location | Distance from rectum (in centimeters) | Totalᵇ n (%) | Female n (%) | Male n (%) | p-value |
|---|---|---|---|---|---|
...
ᵃPercent in row might not sum to 100 due to rounding.
ᵇPercent of total patients
