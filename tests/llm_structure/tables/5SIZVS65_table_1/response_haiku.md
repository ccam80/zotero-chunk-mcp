| Age | Totalᵇ, n (%) | Female, n (%) | Male, n (%) | p-value |
|-----|---------------|---------------|-------------|---------|
...
ᵃPercent in row might not sum to 100 due to rounding. Chi-square tests compare sex distribution by age category, and overall. Mean ages compared by Wilcoxon test
ᵇPercent of all patients (n = 13,881)
