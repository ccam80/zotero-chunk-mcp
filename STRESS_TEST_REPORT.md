...
| linssen-emg-fatigue-1993 | 8 | 7 | 3 | 2 | A | 3 unknown sections; no abstract detected |
| berntson-hrv-origins-1997 | 27 | 36 | 0 | 0 | A | 31 unknown sections |
| ats-ers-respiratory-muscl | 107 | 313 | 18 | 61 | A | 271 unknown sections; no abstract detected |
| schroeder-hrv-repeatabili | 10 | 8 | 5 | 0 | A | none |
| raez-emg-techniques-2006 | 25 | 21 | 4 | 10 | B | 1 figs missing; 13 unknown sections |
...
| flett-wearable-hr-accurac | 19 | 1 | 5 | 12 | A | 1 unknown sections; no abstract detected |
...
Table 0: 25/52 cells non-empty (48%). Caption: 'TABLE 1. PRESSURES FOR BASIC RESPIRATORY MECHANICS'
...
1 figure(s) have captions but no extracted image. Captions found: 11, figures extracted: 10

### !!! [MAJOR] unmatched-captions — raez-emg-techniques-2006

Caption numbers found on pages but not matched to any extracted object: figures=['8'], tables=none
...
### !!! [MAJOR] paddle-gt-cell-accuracy — VP3NJ74M

VP3NJ74M_table_5: cell_accuracy=0.0%, fuzzy=41.1%, splits=0, merges=0, cell_diffs=15

### !!! [MAJOR] paddle-gt-cell-accuracy — VP3NJ74M

VP3NJ74M_table_6: cell_accuracy=0.0%, fuzzy=16.7%, splits=0, merges=0, cell_diffs=10

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_2 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — VP3NJ74M

GT table VP3NJ74M_table_3 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — DPYRZTFI

GT table DPYRZTFI_table_3 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — Z9X4JVZ5

GT table Z9X4JVZ5_table_2 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — VP3NJ74M

GT table VP3NJ74M_orphan_p1_t0 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — Z9X4JVZ5

GT table Z9X4JVZ5_orphan_p5_t0 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — Z9X4JVZ5

GT table Z9X4JVZ5_table_4 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_3 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — XIAINRVS

GT table XIAINRVS_orphan_p1_t0 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — YMWV46JA

GT table YMWV46JA_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — 5SIZVS65

GT table 5SIZVS65_table_3 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — XIAINRVS

GT table XIAINRVS_orphan_p2_t1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — Z9X4JVZ5

GT table Z9X4JVZ5_orphan_p22_t8 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — Z9X4JVZ5

GT table Z9X4JVZ5_table_7 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_2_p19 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — 9GKLLJH9

GT table 9GKLLJH9_table_2 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — 5SIZVS65

GT table 5SIZVS65_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — AQ3D94VC

GT table AQ3D94VC_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — DPYRZTFI

GT table DPYRZTFI_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — DPYRZTFI

GT table DPYRZTFI_orphan_p7_t3 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_orphan_p1_t0 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_2_p20 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_3_p31 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — VP3NJ74M

GT table VP3NJ74M_table_2 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — DPYRZTFI

GT table DPYRZTFI_table_2 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — 5SIZVS65

GT table 5SIZVS65_table_5 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — SCPXVBLY

GT table SCPXVBLY_table_1_p16 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-coverage — C626CYVT

GT table C626CYVT_table_1 NOT matched by paddle extraction

### !!! [MAJOR] paddle-gt-cell-accuracy — XIAINRVS

XIAINRVS_orphan_p1_t0: cell_accuracy=0.0%, fuzzy=0.0%, splits=0, merges=0, cell_diffs=0

### !!! [MAJOR] paddle-gt-cell-accuracy — DPYRZTFI

DPYRZTFI_orphan_p7_t3: cell_accuracy=0.0%, fuzzy=0.0%, splits=0, merges=0, cell_diffs=0

### !!! [MAJOR] paddle-gt-cell-accuracy — VP3NJ74M

VP3NJ74M_table_5: cell_accuracy=0.0%, fuzzy=30.9%, splits=0, merges=0, cell_diffs=15
...
| table-content-quality | active-inference-tutorial/table-5 | Table 5: 44/44 cells non-empty (100%). Caption: 'Table 3. Output fields for spm_ |
...
| table-content-quality | helm-coregulation/table-1 | Table 1: 62/72 cells non-empty (86%). Caption: 'Table 2 Coefficients From Best-F |
...
| table-content-quality | fortune-impedance/table-3 | Table 3: 231/231 cells non-empty (100%). Caption: 'Table 4. Electrode–skin imped |
...
| table-content-quality | linssen-emg-fatigue-1993/table-1 | Table 1: 56/56 cells non-empty (100%). Caption: 'Table 1. Results and reproducib |
| table-content-quality | linssen-emg-fatigue-1993/table-2 | Table 2: 50/50 cells non-empty (100%). Caption: 'Table 2. Correlations.' |
| figure-extraction | linssen-emg-fatigue-1993 | Expected figures — found 2 |
| figure-caption-rate | linssen-emg-fatigue-1993 | 2/2 figures have captions (100%) |
| completeness-grade | linssen-emg-fatigue-1993 | Grade: A / Figs: 2 found / 2 captioned / 0 missing / Tables: 3 found / 2 caption |
...
| figure-images-saved | linssen-emg-fatigue-1993 | 2/2 figure images saved to disk |
...
| table-content-quality | ats-ers-respiratory-muscle-2002/table-11 | Table 11: 17/24 cells non-empty (71%). Caption: 'TABLE 2. ULTRASOUND' |
...
| table-content-quality | ats-ers-respiratory-muscle-2002/table-13 | Table 13: 78/144 cells non-empty (54%). Caption: 'TABLE 2. NORMAL VALUES OF MAXI |
| table-content-quality | ats-ers-respiratory-muscle-2002/table-14 | Table 14: 58/98 cells non-empty (59%). Caption: 'TABLE 3. NORMAL VALUES OF OCCLU |
...
| figure-extraction | ats-ers-respiratory-muscle-2002 | Expected figures — found 61 |
| figure-caption-rate | ats-ers-respiratory-muscle-2002 | 61/61 figures have captions (100%) |
| completeness-grade | ats-ers-respiratory-muscle-2002 | Grade: A / Figs: 61 found / 14 captioned / 0 missing / Tables: 18 found / 4 capt |
...
| figure-images-saved | ats-ers-respiratory-muscle-2002 | 61/61 figure images saved to disk |
...
| figure-extraction | raez-emg-techniques-2006 | Expected figures — found 10 |
| figure-caption-rate | raez-emg-techniques-2006 | 10/10 figures have captions (100%) |
| completeness-grade | raez-emg-techniques-2006 | Grade: B / Figs: 10 found / 11 captioned / 1 missing / Tables: 4 found / 3 capti |
...
| figure-images-saved | raez-emg-techniques-2006 | 10/10 figure images saved to disk |
...
| table-content-quality | shaffer-hrv-norms-2017/table-0 | Table 0: 26/27 cells non-empty (96%). Caption: 'Table 1. HRV time-domain measure |
...
| table-content-quality | charlton-wearable-ppg-2022/table-1 | Table 1: 168/170 cells non-empty (99%). Caption: 'Table 2. Datasets of PPG Signa |
...
| table-extraction | flett-wearable-hr-accuracy-2025 | Expected tables — found 5 |
...
| completeness-grade | flett-wearable-hr-accuracy-2025 | Grade: A / Figs: 12 found / 12 captioned / 0 missing / Tables: 5 found / 5 capti |
| content-readability | flett-wearable-hr-accuracy-2025 | 0 tables with readability issues |
| table-dimensions-sanity | flett-wearable-hr-accuracy-2025 | 0 tables are 1x1 (degenerate) |
...
| table-search-recall | active-inference-tutorial | Query: 'algorithm update rules' — found 5 matching table(s), best score 0.243, c |
...
| table-markdown-quality | ats-ers-respiratory-muscle-2002 | Table markdown has pipes and 29 lines. Preview: **TABLE 1. PRESSURES FOR BASIC R |
...
| table-markdown-quality | charlton-wearable-ppg-2022 | Table markdown has pipes and 37 lines. Preview: **Table 2. Datasets of PPG Signa |
...
| figure-search-recall | raez-emg-techniques-2006 | Query: 'EMG signal motor unit' — found 8 matching figure(s), best score 0.535, c |
...
| author-filter | laird-fick-polyps | Filter author='laird' — target paper found (28 total results after filter) |
...
| author-filter | shaffer-hrv-norms-2017 | Filter author='shaffer' — target paper found (23 total results after filter) |
...
| context-expansion | roland-emg-filter | Context expansion: before=4, after=2, full_context=9900 chars |
| context-adds-value | roland-emg-filter | Full context (9900 chars) vs hit (1503 chars) |
...
| context-expansion | ats-ers-respiratory-muscle-2002 | Context expansion: before=2, after=10, full_context=24900 chars |
| context-adds-value | ats-ers-respiratory-muscle-2002 | Full context (24900 chars) vs hit (3152 chars) |
...
| section-weight-effect | all | Default top-3 sections: ['table', 'table', 'unknown'], methods-boosted top-3: [' |
...
| paddle-orphan-count | SCPXVBLY | 8 orphan table(s) out of 10 extracted |
| paddle-orphan-count | XIAINRVS | 0 orphan table(s) out of 0 extracted |
| paddle-orphan-count | C626CYVT | 1 orphan table(s) out of 1 extracted |
| paddle-orphan-count | 5SIZVS65 | 3 orphan table(s) out of 5 extracted |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_2: cell_accuracy=1.2%, fuzzy=71.0%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_2: accuracy=1.2% recorded |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_4: cell_accuracy=13.5%, fuzzy=90.2%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_4: accuracy=13.5% recorded |
| paddle-orphan-count | 9GKLLJH9 | 1 orphan table(s) out of 2 extracted |
| paddle-gt-cell-accuracy | 9GKLLJH9 | 9GKLLJH9_table_1: cell_accuracy=52.5%, fuzzy=90.7%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | 9GKLLJH9 | 9GKLLJH9_table_1: accuracy=52.5% recorded |
| paddle-orphan-count | Z9X4JVZ5 | 3 orphan table(s) out of 7 extracted |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_1: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_1: accuracy=100.0% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_3: cell_accuracy=66.7%, fuzzy=77.3%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_3: accuracy=66.7% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_6: cell_accuracy=91.7%, fuzzy=95.5%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_6: accuracy=91.7% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_5: cell_accuracy=91.7%, fuzzy=95.5%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_5: accuracy=91.7% recorded |
| paddle-orphan-count | YMWV46JA | 0 orphan table(s) out of 0 extracted |
| paddle-orphan-count | DPYRZTFI | 3 orphan table(s) out of 3 extracted |
| paddle-orphan-count | VP3NJ74M | 5 orphan table(s) out of 9 extracted |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_1: cell_accuracy=60.0%, fuzzy=71.2%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_1: accuracy=60.0% recorded |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_5: accuracy=0.0% recorded |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_6: accuracy=0.0% recorded |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_4: cell_accuracy=73.6%, fuzzy=47.7%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_4: accuracy=73.6% recorded |
| paddle-orphan-count | AQ3D94VC | 1 orphan table(s) out of 5 extracted |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_2: cell_accuracy=88.5%, fuzzy=82.5%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_2: accuracy=88.5% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_4: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_4: accuracy=100.0% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_3: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_3: accuracy=100.0% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_5: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_5: accuracy=100.0% recorded |
| paddle-orphan-count | 5746WSRD | 1 orphan table(s) out of 1 extracted |
| paddle-orphan-count | E4WMHZH5 | 1 orphan table(s) out of 2 extracted |
| paddle-orphan-count | HISJD5UI | 0 orphan table(s) out of 0 extracted |
| paddle-orphan-count | 6KB8FWFN | 6 orphan table(s) out of 19 extracted |
| paddle-orphan-count | QB3J4QTQ | 3 orphan table(s) out of 5 extracted |
| paddle-orphan-count | SWB2E2Q9 | 3 orphan table(s) out of 4 extracted |
| paddle-orphan-count | W3FYXN62 | 2 orphan table(s) out of 5 extracted |
| paddle-orphan-count | HGGB64RC | 5 orphan table(s) out of 7 extracted |
| paddle-orphan-count | RE7X5G2Q | 3 orphan table(s) out of 3 extracted |
| paddle-orphan-count | ETKMWLI7 | 1 orphan table(s) out of 5 extracted |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_5 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_6 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_3 matched by paddle extraction |
| paddle-gt-coverage | 9GKLLJH9 | GT table 9GKLLJH9_table_1 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_5 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_1 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_4 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_3 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_5 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_6 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_1 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_2 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_2 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_4 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_4 matched by paddle extraction |
| paddle-orphan-count | SCPXVBLY | 5 orphan table(s) out of 10 extracted |
| paddle-gt-cell-accuracy | SCPXVBLY | SCPXVBLY_table_1: cell_accuracy=23.8%, fuzzy=53.4%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | SCPXVBLY | SCPXVBLY_table_1: accuracy=23.8% recorded |
| paddle-gt-cell-accuracy | SCPXVBLY | SCPXVBLY_table_1_p16: cell_accuracy=55.6%, fuzzy=81.8%, splits=0, merges=0, cell |
| paddle-gt-accuracy-recorded | SCPXVBLY | SCPXVBLY_table_1_p16: accuracy=55.6% recorded |
| paddle-orphan-count | XIAINRVS | 1 orphan table(s) out of 1 extracted |
| paddle-gt-accuracy-recorded | XIAINRVS | XIAINRVS_orphan_p1_t0: accuracy=0.0% recorded |
| paddle-orphan-count | C626CYVT | 0 orphan table(s) out of 1 extracted |
| paddle-gt-cell-accuracy | C626CYVT | C626CYVT_table_1: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | C626CYVT | C626CYVT_table_1: accuracy=100.0% recorded |
| paddle-orphan-count | 5SIZVS65 | 0 orphan table(s) out of 5 extracted |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_1: cell_accuracy=5.0%, fuzzy=62.6%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_1: accuracy=5.0% recorded |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_2: cell_accuracy=2.4%, fuzzy=73.5%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_2: accuracy=2.4% recorded |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_3: cell_accuracy=5.7%, fuzzy=70.7%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_3: accuracy=5.7% recorded |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_4: cell_accuracy=7.3%, fuzzy=61.7%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_4: accuracy=7.3% recorded |
| paddle-gt-cell-accuracy | 5SIZVS65 | 5SIZVS65_table_5: cell_accuracy=4.2%, fuzzy=70.6%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | 5SIZVS65 | 5SIZVS65_table_5: accuracy=4.2% recorded |
| paddle-orphan-count | 9GKLLJH9 | 0 orphan table(s) out of 2 extracted |
| paddle-gt-cell-accuracy | 9GKLLJH9 | 9GKLLJH9_table_1: cell_accuracy=95.0%, fuzzy=97.1%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | 9GKLLJH9 | 9GKLLJH9_table_1: accuracy=95.0% recorded |
| paddle-gt-cell-accuracy | 9GKLLJH9 | 9GKLLJH9_table_2: cell_accuracy=75.6%, fuzzy=76.4%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | 9GKLLJH9 | 9GKLLJH9_table_2: accuracy=75.6% recorded |
| paddle-orphan-count | Z9X4JVZ5 | 0 orphan table(s) out of 7 extracted |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_1: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_1: accuracy=100.0% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_2: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_2: accuracy=100.0% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_3: cell_accuracy=40.0%, fuzzy=62.0%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_3: accuracy=40.0% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_4: cell_accuracy=44.4%, fuzzy=61.5%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_4: accuracy=44.4% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_5: cell_accuracy=91.7%, fuzzy=92.6%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_5: accuracy=91.7% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_6: cell_accuracy=91.7%, fuzzy=92.6%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_6: accuracy=91.7% recorded |
| paddle-gt-cell-accuracy | Z9X4JVZ5 | Z9X4JVZ5_table_7: cell_accuracy=91.7%, fuzzy=97.4%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | Z9X4JVZ5 | Z9X4JVZ5_table_7: accuracy=91.7% recorded |
| paddle-orphan-count | YMWV46JA | 0 orphan table(s) out of 0 extracted |
| paddle-orphan-count | DPYRZTFI | 1 orphan table(s) out of 4 extracted |
| paddle-gt-cell-accuracy | DPYRZTFI | DPYRZTFI_table_1: cell_accuracy=98.1%, fuzzy=98.9%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | DPYRZTFI | DPYRZTFI_table_1: accuracy=98.1% recorded |
| paddle-gt-cell-accuracy | DPYRZTFI | DPYRZTFI_table_2: cell_accuracy=98.4%, fuzzy=99.0%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | DPYRZTFI | DPYRZTFI_table_2: accuracy=98.4% recorded |
| paddle-gt-cell-accuracy | DPYRZTFI | DPYRZTFI_table_3: cell_accuracy=99.6%, fuzzy=99.8%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | DPYRZTFI | DPYRZTFI_table_3: accuracy=99.6% recorded |
| paddle-gt-accuracy-recorded | DPYRZTFI | DPYRZTFI_orphan_p7_t3: accuracy=0.0% recorded |
| paddle-orphan-count | VP3NJ74M | 0 orphan table(s) out of 6 extracted |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_1: cell_accuracy=2.9%, fuzzy=71.6%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_1: accuracy=2.9% recorded |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_2: cell_accuracy=66.7%, fuzzy=81.7%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_2: accuracy=66.7% recorded |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_3: cell_accuracy=1.5%, fuzzy=84.2%, splits=0, merges=0, cell_diff |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_3: accuracy=1.5% recorded |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_4: cell_accuracy=69.0%, fuzzy=88.3%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_4: accuracy=69.0% recorded |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_5: accuracy=0.0% recorded |
| paddle-gt-cell-accuracy | VP3NJ74M | VP3NJ74M_table_6: cell_accuracy=15.0%, fuzzy=45.5%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | VP3NJ74M | VP3NJ74M_table_6: accuracy=15.0% recorded |
| paddle-orphan-count | AQ3D94VC | 0 orphan table(s) out of 5 extracted |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_1: cell_accuracy=67.9%, fuzzy=80.7%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_1: accuracy=67.9% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_2: cell_accuracy=73.1%, fuzzy=80.2%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_2: accuracy=73.1% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_3: cell_accuracy=85.3%, fuzzy=93.0%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_3: accuracy=85.3% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_4: cell_accuracy=53.3%, fuzzy=69.4%, splits=0, merges=0, cell_dif |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_4: accuracy=53.3% recorded |
| paddle-gt-cell-accuracy | AQ3D94VC | AQ3D94VC_table_5: cell_accuracy=100.0%, fuzzy=100.0%, splits=0, merges=0, cell_d |
| paddle-gt-accuracy-recorded | AQ3D94VC | AQ3D94VC_table_5: accuracy=100.0% recorded |
| paddle-orphan-count | 5746WSRD | 1 orphan table(s) out of 1 extracted |
| paddle-orphan-count | E4WMHZH5 | 1 orphan table(s) out of 2 extracted |
| paddle-orphan-count | HISJD5UI | 0 orphan table(s) out of 0 extracted |
| paddle-orphan-count | 6KB8FWFN | 4 orphan table(s) out of 21 extracted |
| paddle-orphan-count | QB3J4QTQ | 0 orphan table(s) out of 5 extracted |
| paddle-orphan-count | SWB2E2Q9 | 3 orphan table(s) out of 4 extracted |
| paddle-orphan-count | W3FYXN62 | 3 orphan table(s) out of 6 extracted |
| paddle-orphan-count | HGGB64RC | 1 orphan table(s) out of 7 extracted |
| paddle-orphan-count | RE7X5G2Q | 0 orphan table(s) out of 3 extracted |
| paddle-orphan-count | ETKMWLI7 | 0 orphan table(s) out of 5 extracted |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_5 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_6 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_3 matched by paddle extraction |
| paddle-gt-coverage | 9GKLLJH9 | GT table 9GKLLJH9_table_1 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_5 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_3 matched by paddle extraction |
| paddle-gt-coverage | DPYRZTFI | GT table DPYRZTFI_table_3 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_1 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_2 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_4 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_4 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_3 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_7 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_3 matched by paddle extraction |
| paddle-gt-coverage | 9GKLLJH9 | GT table 9GKLLJH9_table_2 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_5 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_6 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_1 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_1 matched by paddle extraction |
| paddle-gt-coverage | DPYRZTFI | GT table DPYRZTFI_table_1 matched by paddle extraction |
| paddle-gt-coverage | Z9X4JVZ5 | GT table Z9X4JVZ5_table_1 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_2 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_2 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_4 matched by paddle extraction |
| paddle-gt-coverage | AQ3D94VC | GT table AQ3D94VC_table_4 matched by paddle extraction |
| paddle-gt-coverage | VP3NJ74M | GT table VP3NJ74M_table_2 matched by paddle extraction |
| paddle-gt-coverage | SCPXVBLY | GT table SCPXVBLY_table_1 matched by paddle extraction |
| paddle-gt-coverage | DPYRZTFI | GT table DPYRZTFI_table_2 matched by paddle extraction |
| paddle-gt-coverage | 5SIZVS65 | GT table 5SIZVS65_table_5 matched by paddle extraction |
| paddle-gt-coverage | SCPXVBLY | GT table SCPXVBLY_table_1_p16 matched by paddle extraction |
| paddle-gt-coverage | C626CYVT | GT table C626CYVT_table_1 matched by paddle extraction |
...
| laird-fick-polyps | 5SIZVS65_table_2 | 95.8% | 95.8% | 95.8% | 0 | 0 | 5 |
| laird-fick-polyps | 5SIZVS65_table_3 | 93.5% | 93.5% | 93.5% | 0 | 0 | 2 |
...
| reyes-lf-hrv | AQ3D94VC_table_3 | 71.0% | 71.0% | 71.0% | 0 | 0 | 18 |
| reyes-lf-hrv | AQ3D94VC_table_4 | 80.6% | 80.6% | 80.6% | 0 | 0 | 26 |
...
| yang-ppv-meta | DPYRZTFI_table_2 | 99.5% | 99.5% | 99.5% | 0 | 0 | 3 |
| yang-ppv-meta | DPYRZTFI_table_3 | 100.0% | 100.0% | 100.0% | 0 | 0 | 0 |
| active-inference-tutorial | SCPXVBLY_table_1 | 89.0% | 89.0% | 89.0% | 0 | 0 | 5 |
| active-inference-tutorial | SCPXVBLY_table_1_p16 | 96.6% | 96.6% | 96.6% | 0 | 0 | 2 |
| active-inference-tutorial | SCPXVBLY_table_2 | 74.3% | 74.3% | 74.3% | 0 | 0 | 7 |
| active-inference-tutorial | SCPXVBLY_table_2_p19 | 67.4% | 67.4% | 67.4% | 0 | 0 | 5 |
| active-inference-tutorial | SCPXVBLY_table_2_p20 | 91.4% | 91.4% | 91.4% | 0 | 0 | 2 |
...
| fortune-impedance | VP3NJ74M_table_2 | 91.9% | 91.9% | 91.9% | 0 | 0 | 0 |
| fortune-impedance | VP3NJ74M_table_3 | 95.5% | 95.5% | 95.5% | 0 | 0 | 0 |
| fortune-impedance | VP3NJ74M_table_4 | 94.8% | 92.7% | 96.9% | 0 | 0 | 0 |
...
| roland-emg-filter | Z9X4JVZ5_table_4 | 96.0% | 96.0% | 96.0% | 0 | 0 | 1 |
| roland-emg-filter | Z9X4JVZ5_table_5 | 89.9% | 86.1% | 93.9% | 0 | 0 | 0 |
| roland-emg-filter | Z9X4JVZ5_table_6 | 89.9% | 86.1% | 93.9% | 0 | 0 | 0 |
| roland-emg-filter | Z9X4JVZ5_table_7 | 99.8% | 99.8% | 99.8% | 0 | 0 | 0 |

**Overall corpus fuzzy accuracy**: 91.3% (37 tables compared)
...
| roland-emg-filter | 7 | 7 | 0 | 0 |
| schroeder-hrv-repeatability-2004 | 5 | 5 | 0 | 0 |
| shaffer-hrv-norms-2017 | 7 | 7 | 0 | 0 |
...
| HGGB64RC_table_1 | TABLE 1 / HRV time-domain measures. | Table 1. HRV time-domain measures. |
...
| RE7X5G2Q_table_2 | Table 2 Datasets of PPG Signals. Deﬁnitions: Resp—Respirator | Table 2. Datasets of PPG Signals. Definitions: Resp—Respirat |
...
| SCPXVBLY_table_1 | Table 1 Model variables. | Table 1. Model variables. |
